...
export function baueSystem(englisch, empfehlungen = false) {
    ...
    const schema = englisch
        ? [
            ...
            '   "schwelle": 79683, "richtung": "auf|ab", "ziel": 81394}],',
            'For every "bedingungen" entry, ALSO give the three machine-readable fields: "schwelle" is the price level in',
            '"wenn" as a bare number, "richtung" is whether price has to rise ("auf") or fall ("ab") to reach it, and "ziel"',
            'is the price named in "dann" — omit "ziel" when "dann" names no price. They are the SAME numbers as in the two',
            'sentences, not additional ones; they exist so the app can check the condition instead of reading it out of prose.',
        ...
        : [
            ...
            '   "schwelle": 79683, "richtung": "auf|ab", "ziel": 81394}],',
            'Gib zu JEDER Bedingung zusätzlich die drei maschinenlesbaren Felder: „schwelle" ist die Kursmarke aus „wenn"',
            'als blosse Zahl, „richtung" sagt, ob der Kurs dafür steigen („auf") oder fallen („ab") muss, und „ziel" ist die',
            'im „dann" genannte Kursmarke — lass „ziel" weg, wenn dort keine steht. Es sind DIESELBEN Zahlen wie in den',
            'beiden Sätzen, keine zusätzlichen; sie stehen da, damit die App die Bedingung prüfen kann, statt sie aus',
            'Fliesstext herauszulesen.',
